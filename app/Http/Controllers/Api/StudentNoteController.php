...
class StudentNoteController extends Controller
{
    ...
    {
        $notes = $this->scopeByStudentVisibility(
            StudentNote::query()->with(['student', 'writtenBy', 'course']),
            $request
        )
    ...
    {
        $this->authorizeStudentVisibility($request, $student, 'You can only manage notes for students in your assigned lab groups.');
    }
}
